...
class OCIBaseHook(BaseHook):
    ...
    def get_config(self):
        self.config = {
            "user": "ocid1.user.oc1..aaaaaaaauks2pfgde3ain2ljv4ozkelu457hahoxzph6k4tmdfu72jtuxcba",
            "fingerprint": "97:2c:4f:e1:8b:81:1c:49:9b:6d:01:41:3b:7e:3a:d2",
            "key_file": "/Users/angu/.oci/oci_api_key.pem",
            "tenancy": "ocid1.tenancy.oc1..aaaaaaaagkbzgg6lpzrf47xzy4rjoxg4de6ncfiq2rncmjiujvy2hjgxvziq",
            "region": "us-ashburn-1"
        }
